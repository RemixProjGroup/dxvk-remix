...
- [`documentation/RemixApiChangelog.md`](documentation/RemixApiChangelog.md) — every API
  surface change gets a dated entry under the appropriate
  `Added` / `Changed` / `Fixed` / `Removed` heading.
- [`documentation/RemixSDK.md`](documentation/RemixSDK.md) — update only when the
