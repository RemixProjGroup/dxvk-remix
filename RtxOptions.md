...
|rtx.atmosphere.cloudCoverageMean|float|0.85|||Mean cloud coverage across the sky \[0,1\]: 0=clear, 1=overcast\.|
...
|rtx.atmosphere.cloudCoverageSpread|float|1|||Spatial variation amplitude for coverage \[0,1\]\. 0=uniform, 1=full range\.|
...
|rtx.atmosphere.cloudDensity|float|1.65|||Cloud opacity/density multiplier\.|
...
|rtx.atmosphere.cloudNoiseTileKm|float|12|||World\-space tile period \(km\) for the prebaked 3D cloud noise texture\. Smaller = more visible repetition; larger = lower\-frequency cloud detail\. Default 12\.0; viable range 6\-24\.|
...
|rtx.atmosphere.cloudShadowStrength|float|1|||How strongly overcast clouds dim ground and atmosphere lighting \[0\.\.1\]\. 1\.0 = full physical voxel\-grid shadow contribution from cloudVoxelShadowsEnable; 0 = shadows fully muted \(voxel grid still runs but its output is mixed away\)\.|
...
|rtx.atmosphere.cloudSkyAmbientStrength|float|0|||Overall strength of the volumetric sky\-ambient illumination term \[0\.\.3\]\. 0 = feature disabled \(baseline rendering\)\. 1 = physical baseline\. Higher values brighten shadowed fog with sky\-tinted ambient\. Gated on rtx\.skyMode = 1 \(Physical Atmosphere\)\.|
|rtx.atmosphere.cloudSunsetWarmth|float|0.95|||Strength of low\-sun warm tint on sunward side\. 0 = disabled\.|
|rtx.atmosphere.cloudThickness|float|2.75|||Vertical depth of the cloud slab in km\.|
|rtx.atmosphere.cloudTypeMean|float|0.75|||Mean cloud type across the sky \[0,1\]: 0=stratus, 0\.5=stratocumulus, 1=cumulus\.|
|rtx.atmosphere.cloudTypeNoiseScale|float|0.01|||Region size frequency for type noise\. Numerically smaller = larger spatial features\.|
|rtx.atmosphere.cloudTypeSpread|float|0.5|||Spatial variation amplitude for cloud type \[0,1\]\. 0=uniform, 1=full range across the sky\.|
...
|rtx.atmosphere.cloudWorleyCarveStrength|float|0.6|||Schneider15 cauliflower carve strength\. The Worley FBM is subtracted from the Perlin base in the cloud noise bake to produce chunky 3D cell silhouettes\. 0 = pure Perlin \(smooth blobs, flat pancake look\); 1\.0 = aggressive carve \(crushed base shape\)\. 0\.6 default\. CHANGE APPLIES ON GAME RELAUNCH\.|
|rtx.atmosphere.cloudWorleyFrequency|float|1|||Worley feature\-point density, cycles per km\. Smaller = larger cumulus cells \(boulder\-sized chunks\); larger = smaller cells \(cauliflower bumps\)\. Default 1\.0 targets cumulus\-cell scale\. CHANGE APPLIES ON GAME RELAUNCH\.|
|rtx.atmosphere.cloudWorleyOctaves|int|3|||Worley FBM octave count \(clamped 1\.\.4 in the bake shader\)\. Higher = more sub\-scale detail on cell boundaries\. Default 3\. CHANGE APPLIES ON GAME RELAUNCH\.|
...
|rtx.atmosphere.moon0.elevation0|float|45|||Moon 0 elevation in degrees\. Game\-driven every frame\.|
|rtx.atmosphere.moon0.enabled0|bool|False|||Enable moon 0 rendering\.|
|rtx.atmosphere.moon0.phase0|float|0.5|||Moon 0 phase \[0,1\]\. Game\-driven every frame\.|
|rtx.atmosphere.moon0.rotation0|float|90|||Moon 0 rotation in degrees\. Game\-driven every frame\.|
...
|rtx.atmosphere.moon1.elevation1|float|45|||Moon 1 elevation in degrees\. Game\-driven every frame\.|
|rtx.atmosphere.moon1.enabled1|bool|False|||Enable moon 1 rendering\.|
|rtx.atmosphere.moon1.phase1|float|0.5|||Moon 1 phase \[0,1\]\. Game\-driven every frame\.|
|rtx.atmosphere.moon1.rotation1|float|90|||Moon 1 rotation in degrees\. Game\-driven every frame\.|
...
|rtx.atmosphere.moon2.elevation2|float|45|||Moon 2 elevation in degrees\. Game\-driven every frame\.|
|rtx.atmosphere.moon2.enabled2|bool|False|||Enable moon 2 rendering\.|
|rtx.atmosphere.moon2.phase2|float|0.5|||Moon 2 phase \[0,1\]\. Game\-driven every frame\.|
|rtx.atmosphere.moon2.rotation2|float|90|||Moon 2 rotation in degrees\. Game\-driven every frame\.|
...
|rtx.atmosphere.moon3.elevation3|float|45|||Moon 3 elevation in degrees\. Game\-driven every frame\.|
|rtx.atmosphere.moon3.enabled3|bool|False|||Enable moon 3 rendering\.|
|rtx.atmosphere.moon3.phase3|float|0.5|||Moon 3 phase \[0,1\]\. Game\-driven every frame\.|
|rtx.atmosphere.moon3.rotation3|float|90|||Moon 3 rotation in degrees\. Game\-driven every frame\.|
...
|rtx.atmosphere.starBrightness|float|0.5|||Overall brightness multiplier for stars\. Game\-driven so plugins can fade stars in/out around sunset/sunrise without polluting user\.conf at frame rate\.|
...
|rtx.atmosphere.starRotation|float|0|||Sidereal sky rotation angle in degrees, 0\-360\. Game\-driven every frame\.|
...
|rtx.atmosphere.sunElevation|float|15|||Sun angle from horizon in degrees\. Game\-driven every frame\.|
...
|rtx.atmosphere.sunRotation|float|0|||Rotation of sun around zenith in degrees\. Game\-driven every frame\.|
...
|rtx.volumetrics.transmittanceColor|float3|0.999, 0.999, 0.999|0, 0, 0|1, 1, 1|The color to use for calculating transmittance measured at a specific distance\.<br>Note that this color is assumed to be in sRGB space and gamma encoded as it will be converted to linear for use in volumetrics\.|
