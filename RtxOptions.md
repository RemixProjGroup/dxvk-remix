...
|rtx.atmosphere.moonAmbientAirglow|float|0.0015|||Ambient airglow per\-moon strength contribution to nightLight\. The cloud volume gets a uniform sky\-bounce from each enabled moon scaled by this constant\. Default 0\.0015\.|
...
|rtx.atmosphere.starAmbientCouplingStrength|float|0.005|||Coupling strength of starlight/airglow into the cloud\-march nightLight term\. Adds a faint per\-ray ambient based on \(nightSkyColor \* starBrightness \* this\) so cloud bodies lift slightly under starry skies, the same way moon\-zenith fill brightens cloud bodies near the moon\. Default 0\.01 = per\-mille level; 0 disables the coupling\.|
